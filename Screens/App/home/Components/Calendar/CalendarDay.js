...
class CalendarDay extends Component {
  ...
  static defaultProps = {
    daySelectionAnimation: {
      ...
      backgroundColor: 'black', // Only applicable for LayoutAnimation.Types.spring,
    },
    styleWeekend: true,
    showDayName: true,
    showDayNumber: true,
  ...
  render() {
    ...
    if (this.props.enabled && this.state.selected) {
      ...
      switch (this.props.daySelectionAnimation.type) {
        case 'background':
          dateViewStyle.push({
            backgroundColor: this.props.daySelectionAnimation.backgroundColor,
          });
          break;
        case 'border':
          dateViewStyle.push({
        ...
        <View>
          {this.props.showDayName && (
            <Text
              style={[
                dateNameStyle,
                {fontSize: this.state.dateNameFontSize, marginBottom: 10},
              ]}
